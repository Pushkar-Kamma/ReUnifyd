CREATE INDEX ix_cdm_channel_date ON channel_daily_metrics(channel_id, date);
...
CREATE INDEX ix_vdm_video_date   ON video_daily_metrics(video_id, date);
...
CREATE UNIQUE INDEX uq_platform_channel ON channel (platform_id, external_channel_id);
CREATE UNIQUE INDEX uq_platform_name    ON platform(name);
CREATE UNIQUE INDEX uq_platform_video   ON video   (platform_id, external_video_id);
